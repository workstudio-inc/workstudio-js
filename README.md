...
```
npm install @workstudio/integrations
```
...
```ts
import { IntegrationsClient } from '@workstudio/integrations';
...
```ts
import { connectConnector } from '@workstudio/integrations/browser';
...
```ts
import { openOAuthPopup } from '@workstudio/integrations/browser';
...
import { IntegrationsClient, type Catalog } from '@workstudio/integrations';
...
```ts
import { IntegrationsApiError } from '@workstudio/integrations';
